...
nnoremap <Leader>find :lua require('telescope.builtin').find_files()<CR>

nnoremap <leader>grep :lua require('telescope.builtin').grep_string { search = vim.fn.expand("<cword>") }<CR>
